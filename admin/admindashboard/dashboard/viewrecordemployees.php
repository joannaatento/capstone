...
?>
		        ...
		        <div class="app-header-content"> 
                   ...
                   <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"></a>
                            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
								...
								<li><a class="dropdown-item" href="functions/adminlogoutf.php">Log Out</a></li>
							</ul>
					    ...
					    <li class="nav-item has-submenu">
					        ...
					        <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1" aria-expanded="false" aria-controls="submenu-1">
						        ...
						        <ul class="submenu-list list-unstyled">
							        ...
							        <li class="submenu-item"><a class="submenu-link" href="">Employees</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
  ...
  <tr>
    ...
    <td><input type="text" name="idnumber" value="<?php echo $idnumber; ?>" placeholder="Enter Your ID Number" required></td>
  
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Full Name <span class="help"></span></label></td>
    <td><input type="text" id="name" name="fullname" value="<?php echo $fullname; ?>" placeholder="Enter Your Full Name"></td>
  ...
  <tr>
    ...
    <td><input type="text" name="gradecourse" value="<?php echo $gradecourse; ?>" ></td>
  ...
  <tr>
    ...
    <td><input type="text" name="father" value="<?php echo $father; ?>"></td>
  
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Contact Number</label></td>
    <td><input type="text" name="fcontact" value="<?php echo $fcontact; ?>" ></td>
  </tr>
                   </table>
                   <br>
                   <table>
  <tr>
    ...
    <td><input type="text" name="mother" value="<?php echo $mother; ?>" ></td>
 
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Contact Number</label></td>
    <td><input type="text" name="mcontact" value="<?php echo $mcontact; ?>" ></td>
  </tr>
</table>
...
<table>
  <tr>
    <td><input type="checkbox" name="polio" value="polio" <?php if($polio == 'polio') echo 'checked'; ?>> Polio</td>
    <td><input type="checkbox" name="tetanus" value="tetanus" <?php if($tetanus == 'tetanus') echo 'checked'; ?> > Tetanus</td>
    <td><input type="checkbox" name="chickenpox" value="chickenpox" <?php if($chickenpox == 'chikenpox') echo 'checked'; ?>> Chicken Pox</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="measles" value="measles" <?php if($measles == 'measles') echo 'checked'; ?> > Measles</td>
    <td><input type="checkbox" name="mumps" value="mumps" <?php if($mumps == 'mumps') echo 'checked'; ?> > Mumps</td>
    <td><input type="checkbox" name="asthma" value="asthma"> Asthma</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="tb" value="tb" <?php if($tb == 'tb') echo 'checked'; ?>> Pulmonary Tuberculosis</td>
    <td><input type="checkbox" name="hepatitis" value="hepatitis" <?php if($hepatitis == 'hepatitis') echo 'checked'; ?>> Hepatitis</td>
    <td><input type="checkbox" name="fainting" value="fainting" <?php if($fainting == 'fainting') echo 'checked'; ?> > Fainting Spells</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="seizure_epilepsy" value="seizure_epilepsy" <?php if($seizure_epilepsy == 'seizure_epilepsy') echo 'checked'; ?>> Seizure/Epilepsy</td>
    <td><input type="checkbox" name="bleeding" value="bleeding" <?php if($bleeding == 'bleeding') echo 'checked'; ?>> Bleeding Tendencies</td>
    <td><input type="checkbox" name="eyedisorder" value="eyedisorder" <?php if($eyedisorder == 'eyedisorder') echo 'checked'; ?>> Eye Disorder</td>
  </tr>
  <tr>
    <td colspan="3">
      <label>Heart Ailment (please specify)</label>
      <input type="text" name="heart" value="<?php echo $heart; ?>">
  ...
  <tr>
    <td>
      ...
      <input type="text" name="allergyfood" value="<?php echo $allergyfood; ?>"><br><br>
      <label>2. Medicine (if YES please specify, if NO leave it blank)</label>
      <input type="text" name="allergymed" value="<?php echo $allergymed; ?>">
    </td>
  </tr>
  <tr>
    <td>
...
<div class="form-group">
                                <label>Name of the person to be notified in case of emergency:
                                    ...
                                    <input type="text" name="nameperson" value="<?php echo $nameperson; ?>"></div>
                                    <div class="form-group">
                                    <label>Person contact number
                                </label>
                                    <input type="text" name="personcp" value="<?php echo $personcp; ?>">
                                  &nbsp;&nbsp; &nbsp;  <label>Relationship:
                                </label>
