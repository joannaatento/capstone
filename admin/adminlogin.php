...
require_once "function/adminloginf.php";
?>
    ...
    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="js-form-message mb-3" <?= (!empty($username_err)) ? 'has-error' : ''; ?>">
            <div class="js-focus-state input-group form">
              ...
              <input type="text" class="form-control form__input" name="username" placeholder="Username" aria-label="Username" data-msg="Please enter a valid username." data-error-class="u-has-error" data-success-class="u-has-success" value="<?= $username; ?>">
            </div>
