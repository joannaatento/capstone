...
<body class="app">   	
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
			...
			<h1 class="app-page-title">Send a request message for scheduling an appointment</h1>
                <div class="app-card app-card-accordion shadow-sm mb-4">
				    <div class="app-card-header p-4 pb-2  border-0">
				       <h4 class="app-card-title">Services: Dental and Medical only</h4>
				    </div><!--//app-card-header-->
				    <div class="app-card-body p-4 pt-0">
					    <div id="faq1-accordion" class="faq1-accordion faq-accordion accordion">
						    ...
						    <div class="accordion-item">
								...
								<form class="form-horizontal mt-4" action="functions/messageformf.php" method="POST">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="messageModalLabel">Message Box</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit"  name="submit_form_post"  class="btn btn-primary">Send Message</button>
                        </div>
                        </div>
                    </div>
                    </div>
